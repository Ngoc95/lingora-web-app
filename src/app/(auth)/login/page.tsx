  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <button className="w-full rounded-lg bg-gradient-to-r from-[var(--primary-500)] to-[var(--primary-600)] py-3 text-sm font-semibold text-white transition-all hover:from-[var(--primary-600)] hover:to-[var(--primary-700)] hover:shadow-lg">
          Đăng nhập
        </button>
      </div>
      ...
      <p className="text-center text-sm text-[var(--neutral-600)]">
        Chưa có tài khoản?{" "}
        <a href="/register" className="font-medium text-[var(--primary-500)] hover:underline">
          Đăng ký ngay
        </a>
      </p>
    </div>
